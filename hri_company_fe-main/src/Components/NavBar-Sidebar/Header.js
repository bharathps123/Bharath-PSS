      ...
      >
        ...
        <li
          onClick={() => navigate("/HelpFaq")}
            ...
            ><div className="flex"><MdLiveHelp className="mr-4 text-lg"/>Help & FAQ</div>
       ...
       <div className="space-y-2">
                    ...
                    <div
                        ...
                        className={`hover:bg-neutral-100 rounded cursor-pointer flex text-gray-600 items-centercursor-pointer hover:text-sky-700 p-2 font-semibold 
                            ${window.location.pathname === "/Jobs" ? "bg-neutral-100 text-sky-700" : ""}`}
                    >
                        <p className="m-1 flex">
                            <RiDashboardFill className="mr-1 text-lg"/>
                            Posted Jobs
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        className={`hover:bg-neutral-100 rounded cursor-pointer flex text-gray-600 items-centercursor-pointer hover:text-sky-700 p-2 font-semibold 
                            ${window.location.pathname === "/ProfileShearedByAdmin" ? "bg-neutral-100 text-sky-700" : ""}`}
                    >
                        <p className="m-1 flex">
                    ...
                    <div
                        ...
                        className={`hover:bg-neutral-100 rounded cursor-pointer flex text-gray-600 items-centercursor-pointer hover:text-sky-700 p-2 font-semibold 
                            ${window.location.pathname === "/Search" ? "bg-neutral-100 text-sky-700" : ""}`}
                    >
                        <p className="m-1 flex">
                            <BsSearch className="mr-1 text-lg"/>
                            Search
                        </p>
                    </div>
                    <div
                        ...
                        className={`hover:bg-neutral-100 rounded cursor-pointer flex text-gray-600 items-centercursor-pointer hover:text-sky-700 p-2 font-semibold 
                            ${window.location.pathname === "/Calender" ? "bg-neutral-100 text-sky-700" : ""}`}
                    >
                        <p className="m-1 flex">
                            <BsCalendar2Event className="mr-1 text-lg"/>
...
<div
                        onClick={() => navigate("/Settings")}
                        className={`hover:bg-neutral-100 rounded cursor-pointer flex text-gray-600 items-centercursor-pointer hover:text-sky-700 p-2 font-semibold 
                            ${window.location.pathname === "/Settings" ? "bg-neutral-100 text-sky-700" : ""}`}
                    >
                        <p className="m-1 flex">
                            <AiTwotoneSetting className="mr-1 text-lg"/>
                            Setting
                        </p>
                    </div>
                    <div
