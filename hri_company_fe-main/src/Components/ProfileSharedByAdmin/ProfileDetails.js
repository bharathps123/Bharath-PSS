            ...
            {data.map((user) => {
                ...
                return (
                    <div key={user.id} className="">
                        ...
                        <div className="grid grid-cols-1 md:text-left md:grid-cols-2 md:mx-24 gap-y-4 md:gap-x-10 lg:gap-x-5 mt-7">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 mt-8 ">
                        ...
                        <div className="md:ml-24 mt-8 flex font-semibold space-x-7 text-4xl">
